...
На момент первичной проверки рабочие контейнеры, профили, промпты, секреты
и основной Compose не менялись. Последующее развёртывание записано в DEPLOYMENT.md.
